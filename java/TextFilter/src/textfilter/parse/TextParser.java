...
//                line = link.getLink();
//                System.out.println("linkTage :" + link.getTagName());
                } else if (node instanceof TitleTag) {
                    TitleTag titlenode = (TitleTag) node;
                    line = titlenode.getTitle();
//                    titlenode.getStringText();
//                    System.out.println(titlenode.getStringText());
//                    System.out.println("titlenode: " + titlenode.getTagName());
                    System.err.println("------------------title-------------");
                } else if (node instanceof ParagraphTag) {
                    ParagraphTag paraTag = (ParagraphTag) node;
                    line = paraTag.getStringText();
                }
                if (line != null && !line.contains("<style") && !line.contains("</style>")
