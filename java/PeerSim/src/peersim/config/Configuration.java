...
// ===================================================================
     ...
     * they are called.
     *
     * 配置文件的debug级别，如果定义，那么会打印每一行读取的configuration参数，如果定义了并
     * 等于DEBUG_EXTENDED，那么会打印额外的上下文调试信息。如果等于DEBUG_FULL，那所以的配置
     * 属性都会在开始时打印，而不是只在它们被调用的时候。
     *
     * @config
     */
